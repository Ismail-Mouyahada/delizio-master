...
function(){
    ...
    $(".js-search-category, .js-search-category2").select2(),$(".js-search-ingredients").select2({maximumSelectionLength:4}),$("#sortable").sortable(),$("#sortable").disableSelection(),$(".btn-light").click(function(){event.preventDefault(),
        $("#sortable").append(`
...
`)
    }), $("#sortable").on("click", ".minusbtn", function () { $(this).parent().parent().parent().remove() })
    });
